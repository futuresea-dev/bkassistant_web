				...
				<div class="main-wrapper-body">
					...
					<section class="official-form-101 padd-20" id="official-form-101">
						<div class="container">
								...
								<div class="row">
									...
									<div class="col-md-5">
										...
										<div class="input-group">
											...
											<input type="text" value="<?php echo Helper::validate_key_value('own_business_name',$used_business_data);?>" class="form-control">
										</div>
										<div class="input-group">
											<label>Business name</label>
											<input type="text" value="" class="form-control">
										...
										<div class="input-group">
											<label>EIN</label>
											<input type="number" value="<?php echo Helper::validate_key_value('own_ein_no',$used_business_data);?>" class="form-control">
										</div>
										<div class="input-group">
											<label>EIN</label>
											<input type="number" value="" class="form-control">
									...
									<div class="col-md-5">
										...
										<div class="input-group">
											<label>EIN</label>
											<input type="number" value="<?php echo Helper::validate_key_value('spouse_ein_no',$used_business_data);?>" class="form-control">
										</div>
										<div class="input-group">
											<label>EIN</label>
											<input type="number" value="" class="form-control">
							...
							$BasicInfo_PartC=$final_BasicInfo_PartC;							
							?>
							<div class="form-border">
								<div class="row mb-3">
									<div class="col-md-2">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="input-group">
													...
													<input type="text" value="<?php echo Helper::validate_key_value('case_filed_state',$BasicInfo_PartC);?>" class="form-control">
												</div>
											</div>
											<div class="col-md-4">
												<div class="input-group">
													<label>When</label>
													<input type="Date" value="<?php echo Helper::validate_key_value('date_filed',$BasicInfo_PartC);?>" class="form-control">
												</div>
											</div>
											<div class="col-md-4">
												<div class="input-group">
													<label>Case number</label>
													<input type="text" value="<?php echo Helper::validate_key_value('case_number',$BasicInfo_PartC);?>" class="form-control">
												</div>
											</div>
										</div>
										<div class="row">
									...
									<div class="col-md-10">
										...
										<div class="row">
											...
											<div class="col-md-3">
												<div class="input-group">
													<label>When</label>
													<input type="date" value="<?php echo Helper::validate_key_value('partner_date_filed',$BasicInfo_PartC);?>" class="form-control">
												</div>
											</div>
											<div class="col-md-6">
												<div class="input-group">
