...
<div class="tab-pane fade show active" id="section7" role="tabpanel" aria-labelledby="section7-tab">
    <h3 class="section-main-title text-c-blue f-w-800">Spousal Expenses</h3>
	<?php $i=0;?>
    ...
    <div id="current-expenses-part-a">
        <div class="row mt-3">
            <div class="col-md-12">
                <p class="section-part-title"><span>Spousal Expenses Separate Household </span></p>
            </div>
        </div>
        {{--<div class="row">
            <div class="col-md-12">
        ...
        <div class="row <?php echo Helper::key_hide_show_v('any_dependents',$expenses);?>" id="all_dependents">
            <div class="col-md-12">
				<?php if(!empty($expenses['dependent_relationship'])){
					for($i=0;$i<count($expenses['dependent_relationship']);$i++){
				?>
                <div class="form-main w-100 all_dependents_form">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="d-inline radio-primary">
                                    <input type="radio" id="dependent_live_with" name="dependent_live_with[<?php echo $i;?>]" value="1" class="required dependent_live_with" required <?php echo Helper::validate_key_toggle('dependent_live_with',$expenses,0);?>/>
                                    <label for="all_dependents_yes" class="cr">Yes</label>
                                </div>
                                <div class="d-inline radio-primary">
                                    <input type="radio" id="all_dependents_no" name="dependent_live_with[<?php echo $i;?>]" value="0" class="required dependent_live_with" required <?php echo Helper::validate_key_toggle('dependent_live_with',$expenses,1);?>/>
                                    <label for="all_dependents_no" class="cr">No</label>
                                </div>
        ...
        <div class="row">
			...
			<?php //if($rented_flag==false){ //Appear only when property type is owned?>
            <div class="col-md-7 pt-2">
                <div class="form-group">
            ...
            <div class="col-md-7 pt-2">
                <div class="form-group">
                    <label class="d-block">Are there additional mortgage payments? </label>
                    <div class="d-inline radio-primary">
                        <input type="radio" id="mortgage_payments_yes" name="mortgage_payments" onchange="getMortgagePaymentsrData('no');" value="1" required <?php echo Helper::validate_key_toggle('mortgage_payments',$expenses,1);?>/>
                        <label for="mortgage_payments_yes" class="cr">Yes</label>
                    </div>
                    <div class="d-inline radio-primary">
                        <input type="radio" id="mortgage_payments_no" name="mortgage_payments" onchange="getMortgagePaymentsrData('yes');" value="0" required <?php echo Helper::validate_key_toggle('mortgage_payments',$expenses,0);?>/>
                        <label for="mortgage_payments_no" class="cr">No</label>
                    </div>
                </div>
                
                <div class="form-group <?php echo Helper::key_hide_show_v('mortgage_payments',$expenses);?>" id="mortgage_payments_data">
                    <label class="d-block">how much do you pay?</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">$</span>
			...
			<div class="col-md-7">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="number" class="form-control required" name="real_estate_taxes_expenses" value="<?php echo Helper::validate_key_value('real_estate_taxes_expenses',$expenses);?>" />
					</div>
				</div>
			</div>
			<div class="col-md-7">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="number" class="form-control required" name="homeowner_rental_insurance" value="<?php echo Helper::validate_key_value('homeowner_rental_insurance',$expenses);?>" />
					</div>
				</div>
			</div>
			<div class="col-md-7">
				<div class="form-group">
					<label class="d-block">Home Maintenance,Repair,and upkeep expenses</label>
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text">$</span>
						</div>
						<input type="number" class="form-control required" name="homemaintenance_repair_expenses" value="<?php echo Helper::validate_key_value('homemaintenance_repair_expenses',$expenses);?>" />
					</div>
				</div>
			</div>
			<div class="col-md-7">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="number" class="form-control required" name="homeowner_association_dues" value="<?php echo Helper::validate_key_value('homeowner_association_dues',$expenses);?>" />
					</div>
				</div>
			</div>
			<div class="col-md-7">
				<div class="form-group">
					<label class="d-block">Additional mortgage payments for your residence, such as home equity loans</label>
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text">$</span>
						</div>
						<input type="number" class="form-control required" name="homeequity_loan_expenses" value="<?php echo Helper::validate_key_value('homeequity_loan_expenses',$expenses);?>" />
					</div>
				</div>
			</div>
		</div> -->
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group <?php echo Helper::key_hide_show_v('utility_bills',$expenses);?>" id="utility_bills_data">
					...
					<?php //if(!empty($expenses['monthly_utilities_value'])){
						...
						?>
						<div class="form-main w-100 monthly_amount">
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    <input type="text" class="form-control required monthly_utilities_bills" name="monthly_utilities_bills" value="<?php echo Helper::validate_key_value('monthly_utilities_bills',$expenses);?>" placeholder="Specify" />
                                </div>
                        </div>
                            <div class="col-md-7">
                                ...
                                <span class="input-group-text" id="basic-addon1">$</span>
                                    ...
                                    <input type="number" name="monthly_utilities_value" class="form-control" placeholder="Description" value="<?php echo Helper::current(Helper::validate_key_value('monthly_utilities_value',$expenses));?>" >
                                </div>
                            </div>
                            ...
                            <!-- <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control required monthly_utilities_value" name="monthly_utilities_value[<?php echo $i;?>]" value="<?php echo Helper::validate_key_loop_value('monthly_utilities_value',$expenses, $i);?>"/>
                                </div>
                            </div> -->
                        </div>
						<br>
            ...
            <div class="col-md-12">
                <h3 class="font-lg-18 mt-3">Insurance NOT deducted from wages or included in home mortgage payments or other real estate property expenses:</h3>
                <div class="row pt-2">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-inline radio-primary">
                            <input type="radio" id="otherInsNotListedSpouse_yes" name="otherInsNotListedSpouse" onchange="getotherInsNotListedSpouse('yes');" value="1" required <?php echo Helper::validate_key_toggle('otherInsNotListedSpouse',$expenses,0);?>/>
                            <label for="live_separately_yes" class="cr">Yes</label>
                        </div>
                        <div class="d-inline radio-primary">
                            <input type="radio" id="otherInsNotListedSpouse_no" name="otherInsNotListedSpouse" onchange="getotherInsNotListedSpouse('no');" value="0" required <?php echo Helper::validate_key_toggle('otherInsNotListedSpouse',$expenses,1);?>/>
                            <label for="otherInsNotListedSpouse_no" class="cr">No</label>
                        </div>
						<?php //if(!empty($expenses['other_insurance_price'])){
							// for($i=0;$i<count($expenses['other_insurance_price']);$i++){
						?>
					   <div class="form-main w-100 other_insurance">
                            <div class="row  <?php echo Helper::key_hide_show_v2('otherInsNotListedSpouse',$expenses);?>" id="otherInsNotListedSpouse_data">
                                <!--div class="col-md-8">
                                    <div class="form-group">
                                ...
                                <div class="col-md-7">   
                                        <div class="input-group drg-cl">
                                           <input type="text" placeholder="Specify" class="form-control required other_insurance_value" name="other_insurance_value" value= "<?php echo Helper::current(Helper::validate_key_value('other_insurance_value',$expenses));?>" /> 
                                        </div>
                                    </div>
                                <div class="col-md-7">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control required other_insurance_price" name="other_insurance_price[<?php echo $i;?>]" value="<?php echo Helper::current(Helper::validate_key_value('other_insurance_price',$expenses));?>"/>
                                    </div>
                                </div>
                            </div><br>
                        </div>
                    ...
                    <div class="col-md-7">
						...
						?>
                        <div class="form-main w-100 tax_bills">
                            <div class="row">
                                <!--div class="col-md-8">
                                    <div class="form-group">
                    ...
                    <div class="col-md-12">
						...
						?>
                        <div class="form-main w-100 installment_payments">
                            <div class="row">
                                <!--div class="col-md-8">
                                    <div class="form-group">
						...
						<?php }?>
                        <i class="fas fa-trash fa-lg mb-2 mt-2 removeInstallmentPaymentsForm11 text-danger cursor-pointer"></i>
                        </div>
                        </div>
                    </div>
                    <div class="col-md-12 del-btn-ip">
                        <label class="d-block">Alimony, maintenance and support paid to others:</label>
                        <div class="row">
                            <!--div class="col-md-8">
                                <div class="form-group">
                        ...
                        <div class="d-inline radio-primary">
                            <input type="radio" id="PaymentsforadditionaldepSpouse_yes" name="PaymentsforadditionaldepSpouse" onchange="getPaymentsforadditionaldepSpouse('yes');" value="1" required <?php echo Helper::validate_key_toggle('PaymentsforadditionaldepSpouse',$expenses,0);?>/>
                            <label for="PaymentsforadditionaldepSpouse_yes" class="cr">Yes</label>
                        </div>
                        <div class="d-inline radio-primary">
                            <input type="radio" id="otherInsNotListedSpouse_no" name="PaymentsforadditionaldepSpouse" onchange="getPaymentsforadditionaldepSpouse('no');" value="0" required <?php echo Helper::validate_key_toggle('PaymentsforadditionaldepSpouse',$expenses,1);?>/>
                            <label for="PaymentsforadditionaldepSpouse_no" class="cr">No</label>
                        </div>
                        <div class="row " id="PaymentsforadditionaldepSpouse_data">
                            <!--div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" class="form-control required" name="payments_dependents_value" value="<?php //echo Helper::validate_key_value('payments_dependents_value',$expenses);?>"/>
                                </div>
                            </div-->
                            <div class="col-md-7">   
                                  <div class="input-group drg-cl">
                                    <input type="text" placeholder="Specify" class="form-control required payments_dependents_value top-spc" name="payments_dependents_value" value="<?php echo Helper::validate_key_value('payments_dependents_value',$expenses);?>" />
                                 </div>
                          </div>
                            <div class="col-md-7">
                                <div class="input-group">
                    ...
                    <div class="col-md-7 pt-3">
                        <div class="form-group">
                            ...
                            <label class="d-block"> Other Real Property expenses NOT already included </label>
                            <div class="d-inline radio-primary">
                                <input type="radio" id="otherRealPropertyNotAddedSpouse_yes" name="otherRealPropertyNotAddedSpouse" onchange="getotherRealPropertyNotAddedSpouse('yes');" value="1" required <?php echo Helper::validate_key_toggle('otherRealPropertyNotAddedSpouse',$expenses,0);?>/>
                                <label for="otherRealPropertyNotAddedSpouse_yes" class="cr">Yes</label>
                            </div>
                            <div class="d-inline radio-primary">
                                <input type="radio" id="otherInsNotListedSpouse_no" name="otherRealPropertyNotAddedSpouse" onchange="getotherRealPropertyNotAddedSpouse('no');" value="0" required <?php echo Helper::validate_key_toggle('otherRealPropertyNotAddedSpouse',$expenses,1
                            );?>/>
                                <label for="otherRealPropertyNotAddedSpouse_no" class="cr">No</label>
                            </div>
                            <?php //}?>
                            <div class="row <?php echo Helper::key_hide_show_v2('otherRealPropertyNotAddedSpouse',$expenses);?>" id="otherRealPropertyNotAddedSpouse_data">
							<?php //if($rented_flag==false){?>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class=" col-md-12 pt-3">
                                    <div class="form-group">
                                        ...
                                        <div id="div_desc_incexp" class="<?php echo Helper::key_hide_show_v('increase_decrease_expenses_option',$expenses);?>">
                                            <textarea id="increase_decrease_expenses" name="increase_decrease_expenses" class="form-control required" cols="50" rows="4" placeholder="Description"><?php echo Helper::validate_key_value('increase_decrease_expenses',$expenses);?></textarea>
                                        </div>
